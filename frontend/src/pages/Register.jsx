		...
		<div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
			<div className="w-full max-w-md space-y-8">
				<div className="text-center space-y-2">
					...
					<p className="text-gray-500 font-semibold">Enter Your Details to Sign Up</p>
				</div>
						...
						<div className="space-y-2">
							<div className="relative">
								...
								<select
									...
									value={formData.role}
									onChange={handleChange}
									className="w-full pl-10 pr-4 py-2 border rounded-md bg-background text-gray-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent">
									<option
										value=""
										selected>
										{" "}
									...
									<option value="BUChC">BUChC</option>
