  ...
  return (
    <div className="h-[90vh] flex items-center justify-center p-6">
      {approvals.map((approval) => (
        <Card 
          key={approval._id}
          className="w-7/12 h-auto rounded-lg shadow-lg bg-zinc-100">
              ...
              <div className="flex flex-col text-left p-2 space-y-4 flex-1">
                <div className="w-full flex items-center gap-2">
                  ...
                  <Input
                    ...
                    className="w-5/6 pl-2 pr-4 mr-10 border rounded-md bg-background focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
                  />
                </div>
              </div>
              <Separator orientation="vertical" />
              <div className="flex flex-col text-left space-y-4 p-2 flex-1">
                <div className="w-full flex items-center gap-2">
                  ...
                  <Input
                    ...
                    name="cover"
                    onChange={handleChange}
                    className="w-5/6 pl-2 pr-4 border rounded-md bg-background focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
                  />
                </div>
              </div>
            </div>
          ...
          <CardFooter className="flex items-start space-x-6">
            <div className="flex flex-col text-left p-2 space-y-4 flex-1">
              <Button
                ...
                className="w-full flex items-center gap-6 bg-slate-700 text-white hover:bg-slate-600 hover:text-white">
                Launch Event
              </Button>
            </div>
            <div className="flex flex-col text-left p-2 space-y-4 flex-1">
              <Button
                ...
                className="w-full flex items-center gap-2 bg-zinc-700 text-white hover:bg-zinc-600 hover:text-white">
                Postpone Event
              </Button>
            </div>
          </CardFooter>
